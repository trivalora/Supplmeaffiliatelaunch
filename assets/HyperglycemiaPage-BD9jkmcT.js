import{j as i}from"./index-BAmhnkG5.js";import{G as a}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function n({onNavigate:e}){return i.jsx(a,{term:"Hyperglycemia",onNavigate:e,currentPage:"hyperglycemia",definition:"Elevated blood glucose levels above the normal range, commonly associated with diabetes and prediabetes.",detailedExplanation:`Hyperglycemia refers to abnormally high blood glucose (blood sugar) levels. While exact thresholds vary by context, hyperglycemia is generally defined as fasting blood glucose &gt;100 mg/dL (5.6 mmol/L) or random blood glucose &gt;140 mg/dL (7.8 mmol/L).
...
For those with prediabetes or at risk for diabetes, preventing hyperglycemia involves weight loss, regular exercise, healthy diet, and sometimes metformin or other preventive medications.`,examples:["A person with type 2 diabetes may experience hyperglycemia (blood glucose 250 mg/dL) after eating a large carbohydrate-heavy meal without adequate medication.","Someone hospitalized for surgery may develop stress hyperglycemia even without prior diabetes history, requiring temporary insulin therapy.","Chronic hyperglycemia with HbA1c of 9.5% significantly increases risk of diabetic complications like retinopathy and nephropathy."],relatedTerms:[{term:"Blood Glucose",key:"bloodglucose"},{term:"Insulin Resistance",key:"insulinresistance"},{term:"HbA1c",key:"hba1c"},{term:"Prediabetes",key:"prediabetes"},{term:"Glycemic Control",key:"glycemiccontrol"},{term:"Metabolism",key:"metabolism"}]})}export{n as HyperglycemiaPage};
