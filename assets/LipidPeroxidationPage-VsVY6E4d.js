import{j as i}from"./index-BAmhnkG5.js";import{G as a}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function r({onNavigate:e}){return i.jsx(a,{term:"Lipid Peroxidation",abbreviation:"None",onNavigate:e,currentPage:"lipidperoxidation",definition:"The oxidative degradation of lipids (fats) in cell membranes by reactive oxygen species, creating a chain reaction that damages membrane structure and produces toxic byproducts, serving as a key mechanism of oxidative damage in disease and aging.",detailedExplanation:`Lipid peroxidation is a destructive process where reactive oxygen species (ROS) attack polyunsaturated fatty acids (PUFAs) in cellular membranes, initiating a self-propagating chain reaction of oxidative damage. This process compromises membrane integrity, alters membrane protein function, and generates toxic aldehyde byproducts that can damage proteins and DNA throughout the cell.
...
- Maintaining iron stores in normal range (excess iron catalyzes peroxidation)`,examples:["When vitamin E intake is inadequate, erythrocyte (red blood cell) membranes show increased lipid peroxidation, measured as elevated MDA levels (>2.5 μmol/L plasma), potentially leading to hemolysis.","Isoprostane levels (F2-IsoP) in healthy adults typically range from 15-40 pg/mL plasma, but can exceed 100 pg/mL in conditions of severe oxidative stress like sepsis or myocardial infarction.","Supplementation with vitamin E (400-800 IU daily) can reduce markers of lipid peroxidation by 20-40% in individuals with elevated oxidative stress, though effects on clinical outcomes are less consistent."],relatedTerms:[{term:"Oxidative Stress",key:"oxidativestress"},{term:"MDA",key:"mda"},{term:"Free Radicals",key:"freeradicals"},{term:"Antioxidant",key:"antioxidant"},{term:"Oxidized LDL",key:"oxidizedldl"}]})}export{r as LipidPeroxidationPage};
