import{j as i}from"./index-BAmhnkG5.js";import{G as a}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function o({onNavigate:e}){return i.jsx(a,{term:"Pancreatitis",onNavigate:e,currentPage:"pancreatitis",definition:"Inflammation of the pancreas, which can be acute or chronic, causing digestive enzyme activation within the pancreas and potentially leading to serious complications.",detailedExplanation:`Pancreatitis is inflammation of the pancreas—a large gland behind the stomach that produces digestive enzymes and hormones (insulin, glucagon). When the pancreas becomes inflamed, digestive enzymes that are normally released into the small intestine become activated while still in the pancreas, causing damage to pancreatic tissue.
...
In chronic pancreatitis with malabsorption, supplementation with pancreatic enzymes and fat-soluble vitamins is essential. For prevention, avoiding alcohol and managing triglycerides (with omega-3 supplementation or medications if needed) may reduce risk. Antioxidant therapy has been studied with mixed results.`,examples:["A patient presenting with sudden severe upper abdominal pain after a bout of heavy drinking, with lipase 5 times normal, likely has acute alcoholic pancreatitis.","Someone with chronic pancreatitis may experience recurrent pain, weight loss despite adequate food intake, and fatty stools due to pancreatic insufficiency.","Patients with triglyceride levels &gt;1000 mg/dL are at risk for acute pancreatitis and may benefit from triglyceride-lowering therapy."],relatedTerms:[{term:"Inflammation",key:"inflammation"},{term:"Triglycerides",key:"triglycerides"},{term:"Absorption",key:"absorption"},{term:"Metabolism",key:"metabolism"}]})}export{o as PancreatitisPage};
