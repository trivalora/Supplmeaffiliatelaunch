import{j as n}from"./index-BAmhnkG5.js";import{G as t}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function l({onNavigate:e,onContactClick:i,onLegalClick:a}){return n.jsx(t,{term:"Chelated",pronunciation:"key-LAY-shun",definition:"A process where a mineral is bound to an organic molecule, such as an amino acid or organic acid. This binding creates a stable complex that may enhance the mineral's absorption and bioavailability in the body.",detailedExplanation:`The term comes from the Greek word 'chele,' meaning claw, referring to how the organic molecule 'grabs onto' the mineral like a crab's claw.
...
• Context-dependent benefits: Bioavailability advantages may be more significant in certain populations or with certain minerals`,relatedTerms:[{term:"Bioavailability",key:"bioavailability"},{term:"Absorption",key:"absorption"},{term:"Amino Acids",key:"amino-acids"},{term:"Mineral",key:"mineral"},{term:"Phytates",key:"phytates"},{term:"Oxalates",key:"oxalates"},{term:"Glycine",key:"glycine"}],onNavigate:e,currentPage:"chelated",onContactClick:i,onLegalClick:a})}export{l as ChelatedPage};
