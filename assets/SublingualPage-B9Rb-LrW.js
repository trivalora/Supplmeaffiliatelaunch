import{j as a}from"./index-BAmhnkG5.js";import{G as t}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function r({onNavigate:e,onContactClick:i,onLegalClick:n}){return a.jsx(t,{term:"Sublingual Administration",definition:"A method of taking supplements by placing them (typically tablets, lozenges, liquids, or sprays) under the tongue where they dissolve and are absorbed directly into the bloodstream through the mucous membranes, bypassing the digestive system and first-pass liver metabolism.",detailedExplanation:`The term comes from the Latin 'sub' (under) and 'lingua' (tongue). This route bypasses the digestive system and first-pass liver metabolism, potentially offering faster absorption and higher bioavailability for certain compounds.
...
• Research for specific products: Look for evidence that the sublingual form actually provides advantages for that particular supplement`,relatedTerms:[{term:"Bioavailability",key:"bioavailability"},{term:"Absorption",key:"absorption"},{term:"Pharmacokinetics",key:"pharmacokinetics"},{term:"Therapeutic Dose",key:"therapeutic-dose"}],onNavigate:e,currentPage:"sublingual",onContactClick:i,onLegalClick:n})}export{r as SublingualPage};
