import{j as n}from"./index-BAmhnkG5.js";import{G as o}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function m({onNavigate:e,onContactClick:t,onLegalClick:i}){return n.jsx(o,{term:"Pharmacokinetics",definition:"The study of how the body affects a drug or supplement over time, including how it is absorbed, distributed, metabolized, and excreted. It essentially describes 'what the body does to the drug' as opposed to pharmacodynamics, which describes 'what the drug does to the body.'",detailedExplanation:`The ADME Framework:
...
• Individual Variability: Explains why some people respond differently to the same dose`,exampleContext:"Pharmacokinetic analysis revealed that curcumin formulated with piperine had a 20-fold higher Cmax (1.35 µg/mL vs. 0.07 µg/mL) and significantly greater AUC compared to standard curcumin, suggesting enhanced bioavailability. The half-life remained similar at approximately 6-7 hours for both formulations.",relatedTerms:[{term:"Bioavailability",key:"bioavailability"},{term:"Absorption",key:"absorption"},{term:"Metabolism",key:"metabolism"}],onNavigate:e,currentPage:"pharmacokinetics",onContactClick:t,onLegalClick:i})}export{m as PharmacokineticsPage};
