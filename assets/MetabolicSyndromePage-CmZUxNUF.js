import{j as i}from"./index-BAmhnkG5.js";import{G as t}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function n({onNavigate:e}){return i.jsx(t,{term:"Metabolic Syndrome",onNavigate:e,currentPage:"metabolicsyndrome",definition:"A cluster of conditions including central obesity, high blood pressure, high blood sugar, and abnormal cholesterol levels that increase the risk of heart disease, stroke, and type 2 diabetes.",detailedExplanation:`Metabolic syndrome is defined by the presence of at least three of five metabolic abnormalities. Different organizations use slightly different criteria, but the most commonly used are from the National Cholesterol Education Program Adult Treatment Panel III (NCEP ATP III) with modifications:
...
Several supplements have been studied for metabolic syndrome components including omega-3 fatty acids (improve triglycerides and inflammation), magnesium (improves insulin sensitivity), vitamin D, probiotics, berberine, and chromium. However, lifestyle modifications remain the most effective intervention.`,examples:["A 55-year-old man with waist circumference 44 inches, blood pressure 140/90, fasting glucose 110 mg/dL, triglycerides 180 mg/dL, and HDL 35 mg/dL meets all five criteria for metabolic syndrome.","After 6 months of diet and exercise, a woman with metabolic syndrome lost 20 pounds, reducing her waist circumference, blood pressure, and triglycerides, and increasing HDL—no longer meeting metabolic syndrome criteria.","A person with metabolic syndrome has approximately 5 times the risk of developing type 2 diabetes compared to someone without the syndrome."],relatedTerms:[{term:"Insulin Resistance",key:"insulinresistance"},{term:"Blood Glucose",key:"bloodglucose"},{term:"Triglycerides",key:"triglycerides"},{term:"HDL Cholesterol",key:"hdlcholesterol"},{term:"Blood Pressure",key:"bloodpressure"},{term:"Inflammation",key:"inflammation"},{term:"HOMA-IR",key:"homair"},{term:"BMI",key:"bmi"}]})}export{n as MetabolicSyndromePage};
