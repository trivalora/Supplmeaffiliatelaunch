import{j as i}from"./index-BAmhnkG5.js";import{G as t}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function o({onNavigate:e}){return i.jsx(t,{term:"Prediabetes",onNavigate:e,currentPage:"prediabetes",definition:"A condition in which blood glucose levels are higher than normal but not high enough to be classified as type 2 diabetes. It represents an increased risk for developing diabetes and cardiovascular disease.",detailedExplanation:`Prediabetes is a metabolic state between normal glucose regulation and type 2 diabetes, characterized by impaired fasting glucose (IFG), impaired glucose tolerance (IGT), or elevated HbA1c. Without intervention, 15-30% of people with prediabetes will develop type 2 diabetes within 5 years.
...
Unlike type 2 diabetes, prediabetes is often reversible with lifestyle changes. Studies show that sustained weight loss, regular exercise, and dietary improvements can restore normal glucose metabolism in many individuals with prediabetes.`,examples:["A 50-year-old with BMI 32, fasting glucose 110 mg/dL, and HbA1c 6.0% has prediabetes and should begin lifestyle intervention to prevent diabetes.","In the Diabetes Prevention Program, participants who achieved 7% weight loss through diet and exercise reduced their 3-year diabetes risk by 58%.","Someone with prediabetes may have HOMA-IR of 3.5, indicating significant insulin resistance that improves with weight loss and exercise."],relatedTerms:[{term:"Blood Glucose",key:"bloodglucose"},{term:"Insulin Resistance",key:"insulinresistance"},{term:"HbA1c",key:"hba1c"},{term:"HOMA-IR",key:"homair"},{term:"Metabolic Syndrome",key:"metabolicsyndrome"},{term:"Glycemic Control",key:"glycemiccontrol"}]})}export{o as PrediabetesPage};
