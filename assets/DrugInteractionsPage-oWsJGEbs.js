import{j as i}from"./index-BAmhnkG5.js";import{G as s}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function c({onNavigate:e,onContactClick:n,onLegalClick:t}){return i.jsx(s,{term:"Drug Interactions",definition:"Situations where a supplement, food, or medication affects how another drug works in the body. These interactions can increase or decrease the effectiveness of medications, alter their side effects, or create new health risks.",detailedExplanation:`In the context of supplements, drug interactions specifically refer to how dietary supplements influence pharmaceutical medications or other supplements.
...
• Individual variation: Genetics and health status affect interaction likelihood`,relatedTerms:[{term:"Contraindications",key:"contraindications"},{term:"Adverse Effects",key:"adverse-effects"},{term:"Bioavailability",key:"bioavailability"},{term:"Pharmacokinetics",key:"pharmacokinetics"},{term:"Absorption",key:"absorption"},{term:"Electrolytes",key:"electrolytes"},{term:"Blood Glucose",key:"blood-glucose"}],onNavigate:e,currentPage:"drug-interactions",onContactClick:n,onLegalClick:t})}export{c as DrugInteractionsPage};
