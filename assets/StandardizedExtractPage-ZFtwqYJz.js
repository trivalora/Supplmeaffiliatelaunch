import{j as a}from"./index-BAmhnkG5.js";import{G as i}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function d({onNavigate:t,onContactClick:e,onLegalClick:n}){return a.jsx(i,{term:"Standardized Extract",definition:"A botanical or herbal extract that has been processed to contain a guaranteed minimum concentration of one or more specific active compounds or marker compounds. This ensures consistent potency and quality across different batches of the supplement.",detailedExplanation:`Why Standardization Matters:
...
• Transparency about extraction methods`,examples:["A curcumin supplement labeled 'Turmeric Extract (95% curcuminoids)' guarantees that 95% of the extract consists of the active curcuminoid compounds","Ashwagandha standardized to 5% withanolides ensures each dose contains a consistent amount of these key bioactive compounds","Ginkgo biloba standardized to 24% flavone glycosides / 6% terpene lactones matches the concentration used in clinical research"],relatedTerms:[{term:"Bioavailability",key:"bioavailability"},{term:"Third-Party Testing",key:"third-party-testing"},{term:"Therapeutic Dose",key:"therapeutic-dose"}],onNavigate:t,currentPage:"standardized-extract",onContactClick:e,onLegalClick:n})}export{d as StandardizedExtractPage};
