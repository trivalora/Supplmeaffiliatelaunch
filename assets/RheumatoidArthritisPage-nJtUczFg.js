import{j as t}from"./index-BAmhnkG5.js";import{G as i}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function o({onNavigate:e}){return t.jsx(i,{term:"Rheumatoid Arthritis",abbreviation:"RA",onNavigate:e,currentPage:"rheumatoidarthritis",definition:"An autoimmune disease causing chronic inflammation of the joints and other organs.",detailedExplanation:`Rheumatoid arthritis (RA) is a chronic autoimmune inflammatory disorder that primarily affects joints but can also involve other organs. In RA, the immune system mistakenly attacks the synovium (the lining of the membranes that surround the joints), causing painful swelling that can eventually result in bone erosion and joint deformity.
...
Some supplements studied for RA include omega-3 fatty acids (modest anti-inflammatory effects), vitamin D (many RA patients deficient), curcumin (anti-inflammatory properties), and probiotics (immune modulation). Supplements should complement, not replace, disease-modifying medications.`,examples:["A patient with early RA may experience symmetric swelling and stiffness in both wrists and hands, improving with methotrexate treatment.","Long-standing RA can lead to characteristic hand deformities like ulnar deviation and swan-neck deformities.","RA patients often have elevated inflammatory markers (ESR, CRP) and positive anti-CCP antibodies."],relatedTerms:[{term:"Inflammation",key:"inflammation"},{term:"Cytokines",key:"cytokines"},{term:"TNF-α",key:"tnfalpha"},{term:"IL-6",key:"il6"},{term:"IL-1",key:"il1"},{term:"Joint Health",key:"jointhealth"},{term:"CRP",key:"crp"}]})}export{o as RheumatoidArthritisPage};
