  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ node, ...props }) => (
          <h2 className="text-xl font-semibold mb-3 mt-6 text-primary" {...props} />
        ),
        h3: ({ node, ...props }) => (
          <h3 className="text-lg font-semibold mb-2 mt-4 text-primary" {...props} />
        ),
        h4: ({ node, ...props }) => (
          <h4 className="text-base font-semibold mb-2 mt-3 text-primary" {...props} />
        ),
        ...
        code: ({ node, inline, ...props }: any) => 
          inline ? (
            <code className="px-1.5 py-0.5 bg-tertiary rounded text-sm font-mono" {...props} />
          ) : (
            <code className="block p-4 bg-tertiary rounded-lg text-sm font-mono overflow-x-auto mb-4" {...props} />
          ),
        pre: ({ node, ...props }) => (
        ...
        blockquote: ({ node, ...props }) => (
          <blockquote className="border-l-4 border-secondary pl-4 italic my-4 text-foreground/80" {...props} />
        ),
  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        code: ({ node, ...props }) => (
          <code className="px-1 py-0.5 bg-tertiary rounded text-sm font-mono" {...props} />
        ),
        a: ({ node, ...props }) => (
          <a 
 ...
 */
export function hasMarkdownFormatting(content: string | null | undefined): boolean {
