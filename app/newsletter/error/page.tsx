...
export const metadata: Metadata = {
  title: "Subscription Error | Suppl.me",
  description:
    "There was an issue with your newsletter subscription confirmation.",
...
> = {
  "missing-token": {
    ...
    message:
      "The confirmation link appears to be incomplete. Please check your email and click the full link, or try subscribing again.",
  },
  "invalid-token": {
    icon: <XCircle className="w-10 h-10 text-red-600" />,
    title: "Invalid Confirmation Link",
    message:
      "This confirmation link is not valid. It may have already been used. Please try subscribing again.",
  },
  "expired-token": {
    icon: <Clock className="w-10 h-10 text-orange-600" />,
    title: "Link Expired",
    message:
      "This confirmation link has expired. Confirmation links are valid for 24 hours. Please subscribe again to receive a new link.",
  },
  "update-failed": {
    icon: <XCircle className="w-10 h-10 text-red-600" />,
    title: "Confirmation Failed",
    message:
      "We couldn't complete your subscription confirmation. Please try again or contact us if the issue persists.",
  },
  "server-error": {
    icon: <XCircle className="w-10 h-10 text-red-600" />,
