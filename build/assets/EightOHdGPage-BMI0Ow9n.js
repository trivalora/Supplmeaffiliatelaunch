import{j as n}from"./index-BAmhnkG5.js";import{G as i}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function o({onNavigate:e}){return n.jsx(i,{term:"8-OHdG",abbreviation:"8-hydroxy-2'-deoxyguanosine, 8-oxo-dG",onNavigate:e,currentPage:"eightoh dg",definition:"A modified DNA nucleoside formed when reactive oxygen species attack guanine bases in DNA, serving as one of the most widely used biomarkers for oxidative DNA damage and oxidative stress.",detailedExplanation:`8-hydroxy-2'-deoxyguanosine (8-OHdG), also known as 8-oxo-deoxyguanosine, is formed when hydroxyl radicals or other reactive oxygen species oxidize the guanine base in DNA. Among the four DNA bases (adenine, guanine, cytosine, thymine), guanine is most susceptible to oxidation due to its lowest redox potential. The formation and accumulation of 8-OHdG represents oxidative DNA damage that can lead to mutations if not properly repaired.
...
- Unclear whether reducing 8-OHdG translates to improved health outcomes`,examples:["Baseline urinary 8-OHdG in healthy adults typically ranges from 3-8 ng/mg creatinine, while smokers often show levels of 10-15 ng/mg creatinine, reflecting increased oxidative DNA damage.","A study of antioxidant supplementation (vitamins C and E plus beta-carotene for 3 months) reduced urinary 8-OHdG from 12.3 to 8.7 ng/mg creatinine in individuals with metabolic syndrome.","Individuals with poorly controlled type 2 diabetes (HbA1c &gt;8%) show urinary 8-OHdG levels approximately 40-60% higher than non-diabetic controls."],relatedTerms:[{term:"Oxidative Stress",key:"oxidativestress"},{term:"Free Radicals",key:"freeradicals"},{term:"Biomarker",key:"biomarker"},{term:"Antioxidant",key:"antioxidant"},{term:"MDA",key:"mda"}]})}export{o as EightOHdGPage};
