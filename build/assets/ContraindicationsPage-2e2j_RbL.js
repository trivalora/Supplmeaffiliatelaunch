import{j as t}from"./index-BAmhnkG5.js";import{G as o}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function c({onNavigate:e,onContactClick:n,onLegalClick:i}){return t.jsx(o,{term:"Contraindications",definition:"A specific situation, condition, or characteristic that makes a particular supplement or treatment inadvisable or potentially harmful. Contraindications indicate when a supplement should not be used because the risks outweigh any potential benefits.",detailedExplanation:`Understanding contraindications is essential for safe supplement use and helps avoid potentially dangerous situations.
...
• Quality variation: Contaminated or mislabeled products create unpredicted contraindications`,relatedTerms:[{term:"Adverse Effects",key:"adverse-effects"},{term:"Drug Interactions",key:"drug-interactions"},{term:"Therapeutic Dose",key:"therapeutic-dose"},{term:"Blood Glucose",key:"blood-glucose"},{term:"Thyroid Function",key:"thyroid-function"}],onNavigate:e,currentPage:"contraindications",onContactClick:n,onLegalClick:i})}export{c as ContraindicationsPage};
