import{j as i}from"./index-BAmhnkG5.js";import{G as t}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function r({onNavigate:e}){return i.jsx(t,{term:"Enterocytes",abbreviation:"Intestinal Epithelial Cells",onNavigate:e,currentPage:"enterocytes",definition:"The absorptive epithelial cells that line the small intestine, responsible for digesting and absorbing nutrients from food and forming a selective barrier between the intestinal lumen and internal body environment.",detailedExplanation:`Enterocytes are columnar epithelial cells that form the majority (~80%) of the intestinal epithelium lining the small intestine. They are highly specialized cells with a short lifespan (3-5 days) that must efficiently absorb nutrients while maintaining barrier function. The small intestine contains approximately 200-300 square meters of absorptive surface area, largely due to the microscopic structure of enterocytes.
...
Enterocyte dysfunction contributes to malabsorption syndromes, celiac disease, inflammatory bowel disease, and increased intestinal permeability ("leaky gut"). Understanding enterocyte biology is essential for addressing digestive disorders and optimizing nutrient absorption.`,examples:["In celiac disease, gluten exposure damages enterocyte microvilli (villous atrophy), dramatically reducing absorptive surface area and causing malabsorption of nutrients including iron, calcium, and fat-soluble vitamins.","Short-chain fatty acids like butyrate serve as the preferred energy source for colonocytes (colon epithelial cells analogous to enterocytes), while enterocytes in the small intestine primarily use glutamine.","The entire intestinal epithelium, including enterocytes, is completely renewed every 3-5 days, requiring rapid cell division and differentiation to maintain barrier and absorptive functions."],relatedTerms:[{term:"Absorption",key:"absorption"},{term:"Bioavailability",key:"bioavailability"},{term:"Gut Microbiome",key:"gutmicrobiome"},{term:"Inflammation",key:"inflammation"},{term:"SCFA",key:"scfa"}]})}export{r as EnterocytesPage};
