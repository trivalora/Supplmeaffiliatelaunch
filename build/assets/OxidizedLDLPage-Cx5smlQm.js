import{j as i}from"./index-BAmhnkG5.js";import{G as a}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function r({onNavigate:e}){return i.jsx(a,{term:"Oxidized LDL",abbreviation:"oxLDL",onNavigate:e,currentPage:"oxidizedldl",definition:"Low-density lipoprotein particles that have undergone oxidative modification, transforming them from cholesterol transport particles into pro-inflammatory molecules that play a central role in atherosclerosis development and cardiovascular disease.",detailedExplanation:`Oxidized LDL (oxLDL) represents LDL cholesterol particles that have been chemically modified by reactive oxygen species, making them more atherogenic (plaque-forming) than native LDL. This oxidation process is considered a critical early event in atherosclerosis development, transforming LDL from a relatively benign cholesterol carrier into a pathogenic trigger of vascular inflammation.
...
Reducing both LDL cholesterol levels (through statins, diet, lifestyle) and oxidative stress (through antioxidant-rich diets, omega-3 fatty acids, polyphenols) represents a dual approach to reducing atherogenic risk. Antioxidant supplementation trials have shown mixed results, possibly because dietary patterns matter more than isolated antioxidants.`,examples:["In individuals with metabolic syndrome, oxLDL levels are typically 30-50% higher than in healthy controls, correlating with increased inflammatory markers and cardiovascular risk.","Studies show that Mediterranean diet adherence for 3-6 months can reduce oxLDL levels by 15-20% while also improving antioxidant capacity.","High-dose omega-3 supplementation (2-4g EPA+DHA daily) has been shown to reduce oxLDL by approximately 10-15% in some studies, independent of LDL cholesterol reduction."],relatedTerms:[{term:"LDL Cholesterol",key:"ldlcholesterol"},{term:"Oxidative Stress",key:"oxidativestress"},{term:"Atherosclerosis",key:"atherosclerosis"},{term:"Antioxidant",key:"antioxidant"},{term:"MDA",key:"mda"},{term:"Cardiovascular",key:"cardiovascular"}]})}export{r as OxidizedLDLPage};
