import{j as i}from"./index-BAmhnkG5.js";import{G as a}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function d({onNavigate:e,onContactClick:n,onLegalClick:t}){return i.jsx(a,{term:"Therapeutic Dose",definition:"The amount of a supplement or medication that produces a desired beneficial effect or therapeutic outcome. This dose has been demonstrated through clinical research to be effective for treating or preventing a specific condition while remaining within safe limits.",detailedExplanation:`For supplements, therapeutic doses are typically derived from clinical trials showing positive outcomes, though individual needs may vary.
...
• You experience adverse effects`,relatedTerms:[{term:"Efficacy",key:"efficacy"},{term:"Bioavailability",key:"bioavailability"},{term:"Metabolism",key:"metabolism"},{term:"Dose-Dependent",key:"dose-dependent"}],onNavigate:e,currentPage:"therapeutic-dose",onContactClick:n,onLegalClick:t})}export{d as TherapeuticDosePage};
