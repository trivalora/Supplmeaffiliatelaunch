import{j as i}from"./index-BAmhnkG5.js";import{G as t}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function s({onNavigate:e}){return i.jsx(t,{term:"Ulcerative Colitis",abbreviation:"UC",onNavigate:e,currentPage:"ulcerativecolitis",definition:"A chronic inflammatory bowel disease causing inflammation and ulcers in the colon and rectum.",detailedExplanation:`Ulcerative colitis (UC) is a type of inflammatory bowel disease (IBD) characterized by chronic inflammation and ulceration of the innermost lining (mucosa) of the colon (large intestine) and rectum.
...
UC is a chronic disease with a relapsing-remitting course. Most patients alternate between periods of remission and active disease. Approximately 50% are in remission at any given time. Cumulative colectomy rates are ~10-15% at 10 years and ~25-30% at 25 years. Modern biologic therapies have improved outcomes and reduced surgery rates. Colorectal cancer risk begins increasing after 8-10 years of disease.`,examples:["A 25-year-old with ulcerative proctitis experiencing bloody stools and urgency may respond well to topical mesalamine suppositories.","A patient with extensive UC refractory to conventional therapy may achieve remission with biologic therapy like infliximab.","Long-term UC patients require surveillance colonoscopy every 1-2 years after 8-10 years of disease to monitor for dysplasia."],relatedTerms:[{term:"Inflammatory Bowel Disease",key:"inflammatoryboweldisease"},{term:"Inflammation",key:"inflammation"},{term:"Dysbiosis",key:"dysbiosis"},{term:"IL-6",key:"il6"},{term:"TNF-α",key:"tnfalpha"},{term:"CRP",key:"crp"},{term:"SCFA",key:"scfa"},{term:"Gut Microbiome",key:"gutmicrobiome"}]})}export{s as UlcerativeColitisPage};
