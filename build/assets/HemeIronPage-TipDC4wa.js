...
While heme iron offers superior bioavailability, a balanced diet incorporating both heme (from lean meats, poultry, fish) and non-heme sources (legumes, fortified grains, dark leafy greens) provides adequate iron without excessive intake of any single source.`,examples:["A 3 oz serving of beef steak provides approximately 2.5 mg total iron, of which ~1 mg is heme iron with 20-35% absorption (200-350 mcg absorbed) versus ~1.5 mg non-heme iron with ~5% absorption (~75 mcg absorbed).","For a person with iron deficiency anemia, consuming beef liver twice weekly can provide 10-12 mg highly bioavailable heme iron per week, substantially improving iron status more rapidly than plant sources alone.","Studies show that adding just 50g of meat to a plant-based meal can double total iron absorption, not only from the heme iron in meat but also by enhancing non-heme iron absorption from plant foods."],relatedTerms:[{term:"Ferrous Iron",key:"ferrousiron"},{term:"Absorption",key:"absorption"},{term:"Bioavailability",key:"bioavailability"},{term:"Hemoglobin",key:"hemoglobin"},{term:"Anemia",key:"anemia"}]})}export{t as HemeIronPage};
