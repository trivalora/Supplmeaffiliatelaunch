import{j as e}from"./index-BAmhnkG5.js";import{G as i}from"./GlossaryTemplate-DbG5gYya.js";import"./glossaryAutolink-CXM2UmUX.js";function s({onNavigate:n}){return e.jsx(i,{term:"Amino Acids",onNavigate:n,currentPage:"aminoacids",definition:"Organic compounds that serve as the building blocks of proteins, each containing an amino group (-NH₂), a carboxyl group (-COOH), and a unique side chain that determines its properties and function.",detailedExplanation:`Amino acids are fundamental molecules in biology, combining in various sequences to form the proteins that make up muscles, enzymes, hormones, antibodies, and countless other vital structures and functions in the body. There are 20 standard amino acids that combine to create all human proteins.
...
- Can be combined to create complete protein profiles`,examples:["Whey protein provides all essential amino acids in optimal ratios for muscle protein synthesis, making it a popular post-workout supplement.","A complete protein source like whey provides all nine essential amino acids, with particularly high levels of leucine (3g per serving) to trigger muscle protein synthesis.","Eating only rice would provide incomplete protein, but combining it with beans creates a complementary amino acid profile that meets all essential amino acid requirements."],relatedTerms:[{term:"Protein",key:"protein"},{term:"Muscle Protein Synthesis",key:"muscleproteinsynthesis"},{term:"Leucine",key:"leucine"},{term:"Isoleucine",key:"isoleucine"},{term:"Valine",key:"valine"},{term:"Essential Amino Acids",key:"essentialaminoacids"},{term:"Glycine",key:"glycine"},{term:"Proline",key:"proline"}]})}export{s as AminoAcidsPage};
