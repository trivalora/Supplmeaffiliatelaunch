/**
 * SEO-Optimized Content Map for Structured Data
 * 
 * This file contains hand-crafted SEO titles and descriptions for all supplement pages.
 * These are used in JSON-LD structured data for optimal search engine indexing.
 */

export const SEO_SUPPLEMENT_DATA = {
  ashwagandhav2: {
 ...
 */
export function getSEOContent(routeKey) {
 ...
 */
export function getCleanSupplementName(routeKey) {
