...
export const SEO_SUPPLEMENT_DATA: Record<string, SEOSupplementContent> = {
  ashwagandha: {
    ...
    description: 'Evidence-based ashwagandha review for stress, anxiety, and cognition. Clinical trials, dosing, and safety. Compare prices from top retailers.',
  ...
  bcaas: {
    ...
    description: 'BCAAs (leucine, isoleucine, valine) for muscle recovery and performance. Clinical studies, protocols, and price comparison across retailers.',
  ...
  calcium: {
    ...
    description: 'Calcium for bone health and osteoporosis prevention. Forms (citrate vs carbonate), absorption, dosing, and safety. Compare retailer prices.',
  ...
  caseinprotein: {
    ...
    description: 'Micellar casein for overnight muscle recovery and lean mass gains. Compare with whey protein and find best prices across top retailers.',
  ...
  collagenpeptides: {
    ...
    description: 'Hydrolyzed collagen for skin elasticity, joints, and bones. Clinical trials, bioavailability, dosing, and price comparison across retailers.',
  ...
  creatine: {
    ...
    description: 'Creatine monohydrate for strength, power, and cognitive function. 1000+ studies, loading protocols, safety, and best retailer prices.',
  ...
  curcumin: {
    ...
    description: 'Curcumin for inflammation and joint health. Bioavailability solutions (piperine, liposomal), clinical efficacy, and price comparison.',
  ...
  iron: {
    ...
    description: 'Iron for anemia and fatigue. Forms (ferrous sulfate, bisglycinate, heme), absorption strategies, side effects, and price comparison.',
  ...
  magnesium: {
    ...
    description: 'Magnesium for sleep, muscles, and heart health. Bioavailable forms (glycinate, citrate, threonate), optimal dosing, and price comparison.',
  ...
  multivitamin: {
    ...
    description: 'Multivitamins for nutrient deficiencies and immune support. Bioavailable forms, third-party testing, cost-effectiveness, and price comparison.',
  ...
  omega3: {
    ...
    description: 'Omega-3 (EPA/DHA) for heart, brain, and inflammation. Clinical trials, IFOS purity standards, optimal dosing, and retailer price comparison.',
  ...
  prebiotics: {
    ...
    description: 'Prebiotic fibers (inulin, FOS, GOS) for gut health and microbiome. Clinical efficacy, FODMAP considerations, synergy with probiotics, prices.',
  ...
  probiotics: {
    ...
    description: 'Probiotic strains (Lactobacillus, Bifidobacterium) for gut and immune health. CFU counts, strain specificity, storage, and price comparison.',
  ...
  sulforaphane: {
    ...
    description: 'Sulforaphane from broccoli sprouts for detox and antioxidant defense. Myrosinase activity, bioavailability, clinical applications, and prices.',
  ...
  vitaminc: {
    ...
    description: 'Vitamin C for immune function, antioxidants, and collagen. Forms (ascorbic acid, liposomal), mega-dosing, safety, and price comparison.',
  ...
  vitamind: {
    ...
    description: 'Vitamin D3 for bones, immunity, and disease prevention. Blood level targets (25-hydroxyvitamin D), dosing, K2 synergy, and retailer prices.',
  ...
  wheyprotein: {
    ...
    description: 'Whey protein (concentrate, isolate, hydrolysate) for muscle growth and recovery. Leucine content, digestion rates, quality, and prices.',
  ...
  zincv2: {
    ...
    description: 'Scientific review of zinc for immune support, wound healing, testosterone, and skin health. Analysis of forms (picolinate, citrate, gluconate) and balance.',
