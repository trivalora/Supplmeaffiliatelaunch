...
import { 
  Bone, Sun, Heart, Shield, Brain, Activity,
  AlertCircle, Droplet, Zap, Users,
...
export function VitaminDPageNewV2({ 
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    overviewContent: (
      <p>
        Vitamin D is a <span className="font-medium">fat-soluble vitamin</span> and hormone precursor. Your skin produces it when exposed to UVB sunlight, but most people don't get enough sun exposure to maintain optimal levels, making supplementation or fortified foods necessary.
      </p>
    ),
    dietarySources: [
      {
        ...
        description: "10-30 minutes midday sun (varies by skin tone, latitude, season)"
      },
      {
        icon: Droplet,
        title: "Fatty fish",
    ...
    additionalOverviewContent: (
      <p>
        Vitamin D regulates calcium absorption, supports bone mineralization, modulates immune function, and influences gene expression. Deficiency is extremely common, particularly in northern latitudes, during winter, and in darker-skinned individuals.
      </p>
    ),
    ...
    benefits: [
      {
        icon: Bone,
        title: "Bone Health",
        description: "Essential for calcium absorption and bone mineralization; prevents rickets in children and osteomalacia in adults"
      },
      {
        icon: Shield,
        title: "Immune Function",
        description: "Supports immune system; may reduce risk of respiratory infections, especially in deficient individuals"
      },
      {
        icon: Brain,
        title: "Mood Support",
        description: "May reduce risk of depression and support mental health, particularly in those with low levels"
      },
      {
        icon: Heart,
        title: "Cardiovascular Health",
        description: "Observational links to heart health, though causal relationship not fully established"
      },
      {
        icon: Zap,
        title: "Muscle Function",
        description: "Supports muscle strength and function; reduces fall risk in older adults"
      }
    ],
    ...
    drawbacks: [
      {
        ...
        description: "Prolonged intake above 4000 IU/day can cause hypercalcemia (elevated blood calcium)"
      },
      {
        icon: Droplet,
        title: "Kidney Stones",
        description: "Excessive vitamin D increases calcium absorption, potentially raising kidney stone risk"
      },
      {
        icon: Pill,
        title: "Medication Interactions",
        description: "Can interact with certain medications (e.g., steroids, weight loss drugs, cholesterol-lowering drugs)"
      }
    ],
    ...
    buyingGuideItems: [
      {
        icon: Pill,
        title: "D3 vs. D2",
        description: "Choose vitamin D3 (cholecalciferol) over D2 (ergocalciferol). D3 is more effective at raising and maintaining blood levels."
      },
      {
        icon: Droplet,
        title: "Dosage",
        description: "Check IU per serving. Common doses are 1000, 2000, or 5000 IU. Don't exceed 4000 IU daily long-term without medical supervision."
      },
      {
        icon: Shield,
        title: "Third-party testing",
        description: "Look for USP, NSF, or ConsumerLab verification to ensure potency and purity."
      },
      {
        icon: CheckCircle2,
        title: "Get tested",
        description: "Consider testing your vitamin D levels (25-hydroxyvitamin D) to determine appropriate dosage for your needs."
      }
    ],
    ...
    references: [
      ...
      },
      {
        ...
        year: "2017",
        title: "Effect of Monthly High-Dose Vitamin D Supplementation on Cardiovascular Disease in the Vitamin D Assessment Study: A Randomized Clinical Trial",
