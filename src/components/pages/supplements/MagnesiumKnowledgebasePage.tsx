...
export function MagnesiumKnowledgebasePage({
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    dietarySources: [
      {
        ...
        description:
          "Dark leafy greens, nuts (almonds, cashews), seeds (pumpkin, chia), legumes, whole grains",
      },
      {
        icon: Droplet,
        title: "Other sources",
    ...
    benefits: [
      {
        ...
        description:
          "Meta-analysis shows modest reductions in both systolic (~2.0 mmHg) and diastolic (~1.78 mmHg) blood pressure in normotensive and hypertensive adults with at least 300 mg/day for 1+ month",
      },
      {
        icon: TrendingDown,
        title: "Glucose Metabolism",
        description:
          "In people with diabetes or high metabolic risk, supplementation improves fasting plasma glucose (SMD -0.40 to -0.426) and insulin resistance (WMD -0.67) with at least 12 weeks of use",
      },
      {
        icon: Flame,
        title: "Inflammation Reduction",
        description:
          "Reduces serum C-reactive protein (SMD -0.356) and increases nitric oxide (SMD 0.321) in individuals with elevated baseline CRP (>3 mg/L), suggesting anti-inflammatory effects",
      },
      {
        icon: Activity,
        title: "Metabolic Benefits",
        description:
          "Small reductions in BMI (WMD -0.21 kg/m²) observed in subgroups with magnesium deficiency, insulin resistance, obesity, or females taking 48-450 mg/day for 6-24 weeks",
      },
      {
        icon: Droplet,
        title: "Biomarker Response",
        description:
          "Increases circulating magnesium by ~0.04 mmol/L and urinary excretion by 1.52 mmol/24h in a dose- and time-dependent manner, with steady-state at ~20 weeks (serum) and ~40 weeks (urine)",
      },
    ],
    ...
    drawbacks: [
      {
        ...
        description:
          "Most common adverse effect is diarrhea, especially at higher doses. No serious adverse events reported in meta-analyses. Symptoms are dose-dependent for some individuals",
      },
      {
        icon: User,
        title: "Limited Benefit in Healthy Populations",
        description:
          "Healthy, athletic, and younger individuals show little to no benefit for metabolic, inflammatory, or anthropometric outcomes. Effects most pronounced in those with baseline abnormalities",
      },
      {
        icon: Activity,
        title: "Modest Effect Sizes",
        description:
          "While statistically significant, clinical improvements are modest (e.g., 2 mmHg BP reduction, 0.21 kg/m² BMI decrease). Benefits accumulate over time and may be more preventive than therapeutic",
      },
      {
        icon: Zap,
        title: "No Muscle Fitness Benefit in Athletes",
        description:
          "Meta-analysis found no significant improvement in muscle fitness for athletes or healthy young adults. Benefits for muscle fitness observed only in elderly and alcoholics",
      },
    ],
    ...
    researchGrades: [
      {
        ...
        title: "Blood Pressure Reduction",
        description:
          "Good evidence from meta-analysis of 2,028 adults (normotensive and hypertensive).[1] Median dose 368 mg/day for median 3 months reduces systolic BP by 2.0 mmHg and diastolic BP by 1.78 mmHg. At least 300 mg/day for 1+ month needed. Effects more pronounced in higher-quality studies with lower dropout rates.",
      },
      {
        letter: "B",
        title: "Glucose Metabolism",
        ...
        description:
          "Strong evidence from multiple meta-analyses (336-447 magnesium vs 334-442 placebo).[2][3] Reduces fasting plasma glucose and insulin resistance in diabetes or high-risk populations with median 12-14 weeks supplementation. Magnesium oxide most studied; effects greater with longer duration (≥4 months) and higher serum magnesium.",
      },
      {
        letter: "B",
        title: "Inflammation Markers",
        description:
          "Good evidence from meta-analyses (447 magnesium vs 442 placebo).[4] Reduces serum CRP and increases nitric oxide in individuals with baseline CRP >3 mg/L. 250 mg/day magnesium oxide for median 12 weeks (range 4-26). Other inflammatory markers (fibrinogen, IL-1) also improved. No effects on IL-6, TAC, glutathione, TNF-α, or MDA.",
      },
      {
        letter: "C",
        title: "Body Mass Index Reduction",
        description:
          "Moderate evidence showing small BMI reduction with 48-450 mg/day for 6-24 weeks.[5] Effects most evident in subgroups with magnesium deficiency, insulin resistance, obesity, hypertension, or females. No significant changes in body weight, waist circumference, or body fat percentage overall. Clinical significance unclear.",
      },
      {
        letter: "C",
        title: "Magnesium Biomarker Response",
        description:
          "Evidence from meta-analysis (1,105 magnesium vs 1,026 placebo, ages 17-85, median 47 years).[6] Increases circulating magnesium and urinary excretion. Dose- and time-dependent (197-994 mg/day, median 365 mg; 3 weeks-5 years, median 12 weeks). Inorganic forms more effective than organic. Steady-state at ~20 weeks (serum) and ~40 weeks (urine). Higher baseline status → smaller serum increase, greater urinary excretion.",
      },
      {
        letter: "D",
    ...
    references: [
      {
        authors:
          "Zhang, X., Li, Y., Del Gobbo, L.C., Rosanoff, A., Wang, J., et al.",
        year: "2016",
        title:
      ...
      {
        authors:
          "Veronese, N., Watutantrige-Fernando, S., Luchini, C., Solmi, M., Sartore, G., et al.",
        year: "2016",
        title:
      ...
      {
        authors:
          "Veronese, N., Pizzol, D., Smith, L., Dominguez, L., Barbagallo, M.",
        year: "2022",
        title:
      ...
      {
        authors:
          "Veronese, N., Dominguez, L.J., Pizzol, D., Demurtas, J., Smith, L., et al.",
        year: "2021",
        title:
      ...
      {
        authors:
          "Simental-Mendía, L.E., Sahebkar, A., Rodríguez-Morán, M., Guerrero-Romero, F.",
        year: "2016",
        title:
      ...
      {
        authors:
          "Simental-Mendía, L.E., Sahebkar, A., Rodríguez-Morán, M., Zambrano-Galván, G., Guerrero-Romero, F.",
        year: "2017",
        title:
      ...
      {
        authors:
          "Askari, M., Mozaffari, H., Jafari, A., Ghanbari, M., Darooghegi Mofrad, M.",
        year: "2020",
        title:
      ...
      {
        authors:
          "Zhang, X., Del Gobbo, L.C., Hruby, A., Rosanoff, A., He, K., et al.",
        year: "2016",
        title:
