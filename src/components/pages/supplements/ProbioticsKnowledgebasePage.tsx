...
export function ProbioticsKnowledgebasePage({
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    heroDescription:
      "Evidence-based overview of live beneficial bacteria that support digestive health, immune function, and the gut microbiome balance.",
    ...
    overviewContent: (
      <p>
        ...
        amounts, confer a health benefit. The most common probiotic bacteria
        belong to the <span className="font-medium">Lactobacillus</span> and{" "}
        <span className="font-medium">Bifidobacterium</span> genera.
      </p>
    ),
    dietarySources: [
      {
      ...
      },
      {
        ...
        title: "Supplements",
        description:
          "Capsules, powders, or liquids containing specific probiotic strains",
      },
    ],
    additionalOverviewContent: (
      <p>
        Probiotics work by colonizing (temporarily or semi-permanently) the gut,
        competing with harmful bacteria, producing beneficial metabolites, and
        modulating immune responses. Benefits are strain-specific, meaning
        effects vary depending on the exact bacterial species and strain.
      </p>
    ),
    ...
    benefits: [
      {
        ...
        description:
          "Helps restore gut balance after antibiotics, reduces diarrhea, and supports overall digestive function",
      },
      {
        icon: Shield,
        title: "Immune Support",
        description:
          "Modulates immune response and may reduce frequency of colds and infections",
      },
      {
        icon: TrendingDown,
        title: "IBS Symptom Relief",
        description:
          "Certain strains reduce bloating, pain, and irregular bowel movements in IBS patients",
      },
      {
        icon: Users,
        title: "Microbiome Balance",
        description:
          "Helps maintain or restore healthy gut bacterial diversity",
      },
      {
        icon: Brain,
        title: "Mood & Mental Health",
        description:
          "Emerging evidence for gut-brain axis effects on mood and anxiety",
      },
    ],
    ...
    drawbacks: [
      {
        ...
        title: "Gas & Bloating",
        description:
          "Some users experience temporary digestive upset when starting probiotics",
      },
      {
        icon: Pill,
        title: "Strain Specificity",
        description:
          "Effects are highly strain-specific; not all probiotics work for all conditions",
      },
      {
        icon: Droplet,
        title: "Immunocompromised Risk",
        description:
          "Rare risk of infection in severely immunocompromised individuals; consult a doctor first",
      },
      {
        icon: Users,
        title: "Temporary Colonization",
        description:
          "Most probiotics don't permanently colonize the gut; benefits require ongoing supplementation",
      },
    ],
    ...
    researchGrades: [
      {
        ...
        description:
          "Strong evidence showing reduced risk and duration of diarrhea when taken with antibiotics.[1] A 2017 Cochrane systematic review[1] of 31 RCTs (n=8,672) found probiotics reduced the risk of antibiotic-associated diarrhea by 60%, with Lactobacillus rhamnosus GG and Saccharomyces boulardii showing particular efficacy.",
      },
      {
        letter: "B",
        title: "IBS Symptom Management",
        description:
          "Good evidence for certain strains reducing IBS symptoms.[2] A 2020 meta-analysis[2] of 53 RCTs (n=5,545) showed probiotics significantly improved overall IBS symptoms, with Bifidobacterium infantis 35624 and multi-strain combinations showing greatest benefit. Effects on pain, bloating, and bowel habit were moderate.",
      },
      {
        letter: "B",
        title: "Immune Function",
        description:
          "Moderate evidence for reduced cold/flu incidence and severity.[3] A 2015 Cochrane systematic review[3] of 13 RCTs (n=3,720) found probiotics reduced upper respiratory tract infection episodes by 47% and duration by 1.89 days. Lactobacillus and Bifidobacterium strains were most studied, with benefits strongest in children and adults under stress.",
      },
      {
        letter: "B",
        title: "Acute Infectious Diarrhea",
        description:
          "Good evidence for reducing duration and severity of acute diarrhea, especially in children.[4] A 2020 meta-analysis[4] of 82 RCTs found probiotics reduced diarrhea duration by approximately 25 hours and stool frequency on day 2 by approximately one stool.",
      },
      {
        letter: "C",
        title: "Mental Health",
        description:
          "Preliminary promising data for mood and anxiety, but more high-quality studies needed.[5] A 2020 meta-analysis[5] of 10 RCTs (n=1,349) showed modest improvements in depression symptoms, but significant heterogeneity exists and mechanisms remain unclear.",
      },
      {
        letter: "C",
        title: "Ulcerative Colitis",
        description:
          "Mixed evidence with some strain-specific benefits.[6] A 2020 systematic review[6] found VSL#3 (high-potency multi-strain formula) effective for maintaining remission, but other probiotics showed inconsistent results. More research needed on optimal strains and dosing.",
      },
    ],
    ...
    buyingGuideItems: [
      {
        ...
        title: "Strain specificity",
        description:
          "Look for specific strain names (e.g., Lactobacillus rhamnosus GG) not just genus/species. Research your condition to find evidence-based strains.",
      },
      {
        icon: Pill,
        title: "CFU count",
        description:
          "Colony-forming units (CFU) should be guaranteed at expiration, not manufacture. Typical doses: 1-10 billion CFU.",
      },
      {
        icon: Shield,
        title: "Stability & storage",
        description:
          "Check if refrigeration is required. Shelf-stable products are more convenient but verify efficacy data.",
      },
      {
        icon: CheckCircle2,
        title: "Third-party testing",
        description:
          "Choose brands with independent verification (e.g., ConsumerLab, USP) to ensure accurate CFU counts and strain identity.",
      },
    ],
    ...
    references: [
      ...
      },
      {
        ...
        year: "2020",
        title:
          "A taxonomic note on the genus Lactobacillus: Description of 23 novel genera, emended description of the genus Lactobacillus Beijerinck 1901",
        journal:
