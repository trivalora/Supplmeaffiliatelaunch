...
export function CalciumKnowledgebasePage({
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    currentPage: "calcium",
    heroDescription:
      "Evidence-based overview of the most abundant mineral in the human body, essential for bone health, nerve function, muscle contraction, and various physiological processes.",
    ...
    overviewContent: dbOverviewContent || (
      <>
        <p>
          Calcium is a <span className="font-medium">macromineral</span> and the
          most abundant mineral in the human body. It is critical for{" "}
          <span className="font-medium">bone and teeth structure</span>, nerve
          transmission, muscle contraction, blood clotting, and enzyme activity.
        </p>

        <p style={{ marginTop: "var(--space-md)" }}>
          Meta-analytic evidence demonstrates calcium's role in bone health,
          pre-eclampsia risk reduction, blood pressure management, and PMS
          symptom improvement, with the strongest evidence in populations at
          risk of deficiency or specific conditions.
        </p>
      </>
    ),
    dietarySources: [
    ...
    additionalOverviewContent: dbAdditionalContent || (
      <p>
        ...
        The remaining 1% plays vital roles in muscle function, nerve
        transmission, vascular contraction and vasodilation, and hormone
        secretion.
      </p>
    ),
    ...
    benefits: [
      {
        ...
        title: "Bone health",
        description:
          "Core role in skeletal structure and small but significant increases in bone mineral density",
      },
      {
        icon: Shield,
        title: "Osteoporosis prevention",
        description:
          "Essential for preventing bone loss, especially in elderly and postmenopausal populations",
      },
      {
        icon: Apple,
        title: "Pre-eclampsia risk",
        description:
          "Strong evidence for reduced pre-eclampsia risk in pregnancy, particularly in at-risk groups",
      },
      {
        icon: Heart,
        title: "Blood pressure",
        description:
          "Small reduction in blood pressure; potential benefit for hypertension",
      },
      {
        icon: Users,
        title: "PMS symptoms",
    ...
    drawbacks: [
      {
        ...
        description:
          "Mild side effects like bloating or constipation possible at high doses",
      },
      {
        icon: Pill,
        title: "Kidney stones",
        description:
          "High calcium intake may increase risk in susceptible individuals; consult a healthcare provider if you have a history of kidney stones",
      },
      {
        icon: Activity,
        title: "Interaction with medications",
        description:
          "Can interfere with absorption of certain medications (e.g., antibiotics, thyroid hormones)",
      },
      {
        icon: Heart,
        title: "Cardiovascular concerns",
        description:
          "Some studies suggest very high supplemental calcium may be associated with increased cardiovascular risk (evidence mixed)",
      },
    ],
    ...
    researchGrades: [
      {
        ...
        description:
          "Strong, consistent evidence from multiple high-quality RCTs showing calcium's critical role in bone mineral density and fracture prevention.[1] A 2017 meta-analysis[1] of 33 RCTs (n=51,145) found calcium supplementation (with or without vitamin D) increased bone mineral density by 0.7-1.8% at various skeletal sites and reduced total fracture risk by 12%. Effects are most pronounced when combined with vitamin D and in populations with low baseline calcium intake.",
      },
      {
        letter: "A",
        title: "Pre-eclampsia Prevention",
        description:
          "Robust evidence from systematic reviews demonstrating significant reduction in pre-eclampsia risk, especially in low-calcium populations.[2] A 2018 Cochrane systematic review[2] of 27 RCTs (n=18,587 women) found calcium supplementation (≥1g/day) reduced pre-eclampsia risk by 55%, with greatest benefits in women with low baseline calcium intake and those at high risk of pre-eclampsia. Also reduced preterm birth risk.",
      },
      {
        letter: "B",
        title: "Blood Pressure Reduction",
        description:
          "Moderate evidence showing small but meaningful reductions in blood pressure, particularly in those with low baseline calcium intake.[3] A 2015 meta-analysis[3] of 18 RCTs found calcium supplementation (1,000-2,000mg/day) reduced systolic blood pressure by 1.43 mmHg and diastolic by 0.98 mmHg. Effects were larger in participants with low baseline calcium intake and hypertension.",
      },
      {
        letter: "B",
        title: "PMS Symptom Relief",
        description:
          "Good evidence from multiple RCTs showing improvement in premenstrual syndrome symptoms with calcium supplementation.[4] A 2017 systematic review[4] of 10 studies found 1,000-1,200mg/day calcium significantly reduced PMS symptoms, including mood disturbances, water retention, and pain, with effects typically emerging after 2-3 menstrual cycles.",
      },
      {
        letter: "C",
        title: "Colorectal Cancer Prevention",
        description:
          "Mixed evidence for potential protective effects.[5] A 2020 meta-analysis[5] of 15 cohort studies found modest inverse associations between calcium intake and colorectal cancer risk, but supplementation trials showed inconsistent results. More research needed to establish optimal dosing and target populations.",
      },
      {
        letter: "C",
        title: "Weight Management",
        description:
          "Preliminary evidence suggests calcium may play a role in fat metabolism and weight regulation.[6] A 2016 meta-analysis[6] found modest weight loss effects with dairy calcium but limited evidence for supplemental calcium alone. Mechanisms remain under investigation.",
      },
    ],
    ...
    buyingGuideIntro:
      "When shopping for calcium supplements, consider these key factors:",
    buyingGuideItems: [
      {
        icon: Pill,
        title: "Form of calcium",
        description:
          "Calcium citrate (better absorbed, can take without food) vs. calcium carbonate (requires food, less expensive, higher elemental calcium)",
      },
      {
        icon: Zap,
        title: "Elemental calcium content",
        description:
          "Check the label for 'elemental calcium' not just total compound weight. Aim for 500-600mg elemental calcium per dose.",
      },
      {
        icon: Shield,
        title: "Third-party testing",
        description:
          "Look for USP, NSF, or ConsumerLab certification to ensure purity and accurate labeling",
      },
      {
        icon: Activity,
        title: "Added nutrients",
        description:
          "Many formulas include vitamin D (enhances absorption) and magnesium (works synergistically with calcium)",
      },
    ],
    ...
    references: [
      ...
      {
        authors:
          "Pereira, M.A., Jacobs, D.R., Van Horn, L., Slattery, M.L., Kartashov, A.I., Ludwig, D.S.",
        year: "2002",
        title:
      ...
      },
      {
        ...
        year: "2018",
        title:
          "The relationship between premenstrual syndrome and food patterns in university student girls",
