...
export function BcaaKnowledgebasePage({ 
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    overviewContent: (
      <>
        <p>Branched-chain <a href="/glossary/aminoacids" onClick={(e) => { e.preventDefault(); onNavigate?.('amino-acids' as PageKey); }} className="text-primary hover:underline">amino acids</a> (BCAAs) are three <a href="/glossary/essentialaminoacids" onClick={(e) => { e.preventDefault(); onNavigate?.('essential-amino-acids' as PageKey); }} className="text-primary hover:underline">essential amino acids</a>—leucine, isoleucine, and valine—that cannot be produced by the body and must be obtained through diet or supplementation. They make up approximately 35% of muscle protein and play a critical role in <a href="/glossary/muscleproteinsynthesis" onClick={(e) => { e.preventDefault(); onNavigate?.('muscle-protein-synthesis' as PageKey); }} className="text-primary hover:underline">muscle protein synthesis</a>.</p>
        
        <p style={{ marginTop: 'var(--space-md)' }}>Meta-analytic evidence indicates <a href="/glossary/bcaa" onClick={(e) => { e.preventDefault(); onNavigate?.('bcaa' as PageKey); }} className="text-primary hover:underline">BCAA</a> supplementation demonstrates strongest benefits in liver cancer surgery (38% reduction in post‐operative infections, 45% reduction in ascites) and exercise-induced muscle damage (large reductions in <a href="/glossary/creatinekinase" onClick={(e) => { e.preventDefault(); onNavigate?.('creatine-kinase' as PageKey); }} className="text-primary hover:underline">creatine kinase</a> and <a href="/glossary/doms" onClick={(e) => { e.preventDefault(); onNavigate?.('doms' as PageKey); }} className="text-primary hover:underline">delayed onset muscle soreness</a>), with an acceptable safety profile showing mild <a href="/glossary/adverseeffects" onClick={(e) => { e.preventDefault(); onNavigate?.('adverse-effects' as PageKey); }} className="text-primary hover:underline">adverse events</a> but no serious complications directly attributable to BCAA.</p>
      </>
    ),
