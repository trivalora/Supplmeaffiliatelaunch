...
interface SulforaphanePageProps {
...
export function SulforaphaneKnowledgebasePage({
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    heroDescription:
      "Evidence-based overview of a powerful phytochemical from cruciferous vegetables, with meta-analytic support for autism spectrum disorder symptoms and cardiovascular health.",
    ...
    overviewContent: dbOverviewContent || (
      <>
        <p>
          Sulforaphane is a{" "}
          <span className="font-medium">sulfur-containing compound</span> formed
          when the enzyme myrosinase transforms glucoraphanin found in
          cruciferous vegetables. It's most abundant in broccoli sprouts,
          containing 10-100 times more than mature broccoli.
        </p>

        <p style={{ marginTop: "var(--space-md)" }}>
          Sulforaphane activates the Nrf2 pathway, a master regulator of
    ...
    dietarySources: [
      ...
      },
      {
        ...
        title: "Supplements",
        description:
          "Broccoli sprout extract or glucoraphanin + myrosinase combinations",
      },
    ],
    additionalOverviewContent: dbAdditionalContent || (
      <p>
        Meta-analytic evidence demonstrates notable benefits for autism spectrum
        disorder symptoms and cardiovascular risk markers, with emerging
        evidence for metabolic and cancer-related outcomes. The compound's
        mechanism centers on Nrf2 activation, driving cellular antioxidant and
        detoxification responses that may underlie its diverse health effects.
      </p>
    ),
    ...
    benefits: [
      {
        ...
        description:
          "Meta-analytic evidence shows modest improvements in total symptoms, aberrant behavior, hyperactivity, and social interaction",
      },
      {
        icon: Heart,
        title: "Blood Pressure Reduction",
        description:
          "Significant reductions in systolic (10.9 mmHg) and diastolic (6.95 mmHg) blood pressure in adults with cardiometabolic syndrome",
      },
      {
        icon: Shield,
        title: "Antioxidant & Detoxification",
        description:
          "Activates Nrf2 pathway, boosting the body's own antioxidant and detox enzyme production",
      },
      {
        icon: Flame,
        title: "Metabolic Health",
        description:
          "Promising effects on blood sugar control and inflammation markers in cardiometabolic conditions",
      },
      {
        icon: Apple,
        title: "Neuroprotection",
        description:
          "Preclinical evidence suggests protective effects on brain cells from oxidative damage",
      },
    ],

    drawbacksIntro:
      "Generally well-tolerated with no serious safety concerns reported in meta-analyses, but note:",
    drawbacks: [
      {
        icon: AlertCircle,
        title: "Digestive Upset",
        description:
          "High doses may cause gas, bloating, or nausea in some individuals",
      },
      {
        icon: Activity,
        title: "Thyroid Considerations",
        description:
          "Very high intake of raw cruciferous vegetables may affect thyroid function in susceptible individuals; typical supplement doses appear safe",
      },
      {
        icon: Shield,
        title: "Age-Specific Data Limited",
        description:
          "Most ASD studies did not specify age ranges; cardiovascular studies focused on middle-aged adults (46-58 years)",
      },
      {
        icon: Users,
        title: "Individual Variability",
        description:
          "Response to sulforaphane varies by individual; not everyone may experience the same benefits",
      },
    ],
    ...
    researchGrades: [
      {
        ...
        description:
          "Good evidence from meta-analyses showing modest but consistent improvements.[1] Total symptoms, aberrant behavior, hyperactivity, and social interaction all showed statistically significant benefits. Six randomized controlled trials included. Adverse events were similar between sulforaphane and control groups.",
      },
      {
        letter: "B",
        title: "Blood Pressure & Cardiovascular",
        description:
          "Good evidence for meaningful blood pressure reductions in adults with cardiometabolic syndrome.[2] Meta-analysis[2] of 10 trials (579 participants) showed systolic BP reduction of 10.9 mmHg and diastolic reduction of 6.95 mmHg. Studies used broccoli sprouts providing 112-225 µmol sulforaphane daily for 1-12 weeks.",
      },
      {
        letter: "B",
        title: "Antioxidant Activation",
        description:
          "Good evidence showing activation of Nrf2 pathway and increased antioxidant enzyme expression in humans.[3] This mechanism underlies many protective effects against oxidative stress and cellular damage.",
      },
      {
        letter: "C",
        title: "Cancer Prevention",
        description:
          "Strong mechanistic rationale and animal data, but human clinical evidence remains limited and ongoing.[4] More long-term studies needed to establish preventive benefits.",
      },
    ],
    ...
    buyingGuideItems: [
      {
        ...
        title: "Active form",
        description:
          "Look for stabilized sulforaphane or glucoraphanin + myrosinase combination. Meta-analyses used broccoli sprout preparations in various forms (powder, capsules, fresh/dried).",
      },
      {
        icon: Shield,
        title: "Dosage clarity",
        description:
          "Check for actual sulforaphane content (mg) or sulforaphane yield (µmol), not just broccoli extract weight. Studies showing benefits used 112-225 µmol or equivalent to 5-10g broccoli sprouts daily.",
      },
      {
        icon: Shield,
        title: "Quality & testing",
        description:
          "Choose reputable brands with third-party testing to ensure sulforaphane content and purity. Stability varies by formulation.",
      },
      {
        icon: CheckCircle2,
        title: "Whole food option",
        description:
          "Fresh or frozen broccoli sprouts are a potent, cost-effective source used in many studies. 1-2 oz (30-60g) daily provides substantial sulforaphane comparable to supplement doses.",
      },
    ],
    ...
    references: [
      ...
      {
        authors:
          "Yagishita, Y., Fahey, J.W., Dinkova-Kostova, A.T., Kensler, T.W.",
        year: "2019",
        title:
