...
export function VitaminCKnowledgebasePage({
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    heroDescription:
      "Evidence-based overview of an essential antioxidant vitamin with meta-analytic support for immune function, cardiovascular health, and critical illness outcomes.",
    ...
    overviewContent: dbOverviewContent || (
      <p>
        ...
        <span className="font-medium">essential water-soluble vitamin</span>{" "}
        that acts as a powerful antioxidant and plays crucial roles in immune
        function, collagen synthesis, and iron absorption. Unlike most animals,
        humans cannot synthesize vitamin C and must obtain it through diet or
        supplementation.
      </p>
    ),
    dietarySources: [
      ...
      },
      {
        ...
        title: "Supplements",
        description:
          "Oral tablets/capsules or intravenous (IV) for clinical use",
      },
    ],
    additionalOverviewContent: dbAdditionalContent || (
      <p>
        Meta-analytic evidence supports vitamin C's role in reducing common cold
        duration (though not incidence in general populations), improving
        outcomes in critically ill patients, and supporting cardiovascular
        health through blood pressure reduction and endothelial function
        improvements. High-dose intravenous vitamin C shows promise in critical
        care settings, while oral supplementation provides immune support and
    ...
    benefits: [
      {
        ...
        description:
          "Enhances immune function and reduces common cold duration",
      },
      {
        icon: Heart,
        title: "Cardiovascular & Endothelial Function",
        description:
          "Significant improvements in endothelial function (SMD 0.50 overall, 0.84 in atherosclerosis) and blood pressure reduction in type 2 diabetes",
      },
      {
        icon: Shield,
        title: "Critical Illness Outcomes",
        description:
          "Intravenous vitamin C associated with reduced hospital mortality (OR 0.81) and shorter ICU stays in critically ill patients",
      },
      {
        icon: Zap,
        title: "Metabolic Health",
        description:
          "Modest improvements in glycemic control (HbA1c -0.54%) and lipid profiles in adults with type 2 diabetes",
      },
      {
        icon: Apple,
        title: "Skin Health",
    ...
    drawbacksIntro:
      "Generally safe with no age-specific safety concerns, but note:",
    drawbacks: [
      {
        icon: AlertCircle,
        title: "Digestive Upset",
        description:
          "High doses (>2000mg) may cause diarrhea, nausea, or abdominal cramps in some individuals",
      },
      {
        icon: FlaskConical,
        title: "Limited Prevention Benefit",
        description:
          "Only 3-4% reduction in common cold incidence in general population; not recommended for routine cold prevention except in physically stressed individuals",
      },
      {
        icon: Activity,
        title: "Kidney Stone Risk",
        description:
          "Very high chronic doses (>1000mg daily) may increase oxalate excretion and kidney stone risk in susceptible individuals",
      },
      {
        icon: Droplet,
        title: "Condition-Specific Benefits",
        description:
          "Cardiovascular and metabolic benefits most pronounced in high-risk populations rather than healthy adults",
      },
    ],
    ...
    researchGrades: [
      {
        ...
        description:
          "Strong consistent evidence showing 13-14% reduction in cold duration in children across multiple large meta-analyses.[1][2][3] Three Cochrane reviews[1][2][3] (Hemilä & Chalker 2013, Douglas et al. 2007, Hemilä et al. 2004) with large sample sizes show consistent benefits. Effect is dose-dependent and greater in children than adults (8% reduction).",
      },
      {
        letter: "B",
        title: "Endothelial Function & Cardiovascular Health",
        description:
          "Good evidence for cardiovascular benefits, especially in high-risk populations.[4][5] Meta-analysis[4] (Ashor et al. 2014) shows improved endothelial function, with greater effects in atherosclerosis patients. Type 2 diabetes meta-analysis[5] shows systolic BP reduction of 6.27 mmHg and diastolic reduction of 3.77 mmHg.",
      },
      {
        letter: "B",
        title: "Critical Illness Mortality & ICU Outcomes",
        description:
          "Good evidence from multiple meta-analyses of intravenous vitamin C in critically ill patients.[6] Hospital mortality reduced and ICU stay decreased by 0.76 days. High-dose regimens show stronger effects. No increase in adverse events, acute kidney injury, or need for renal replacement therapy.",
      },
      {
        letter: "C",
        title: "Common Cold Prevention (General Population)",
        description:
          "Limited benefit for routine cold prevention in general population.[1][2][3] Incidence reduction only 3-4% across three Cochrane reviews. However, substantially more effective in physically active individuals under stress (marathon runners, soldiers, skiers). Not recommended for general prophylaxis.",
      },
      {
        letter: "C",
        title: "Glycemic Control in Type 2 Diabetes",
        description:
          "Promising but limited evidence for metabolic benefits.[7] Meta-analysis[7] (Mason et al. 2021) shows HbA1c reduction of 0.54% and triglyceride reduction, but certainty rated as very low due to short study durations (2 weeks to <6 months) and small sample sizes. Long-term effects unclear.",
      },
    ],
    ...
    buyingGuideItems: [
      {
        ...
        description:
          "Ascorbic acid is effective and most economical. Buffered forms (calcium ascorbate, sodium ascorbate) may be gentler on stomach. Liposomal vitamin C claims better absorption but evidence is mixed and cost is higher.",
      },
      {
        icon: Pill,
        title: "Dosage considerations",
        description:
          "Check elemental vitamin C content. For immune support during colds: 1-2g daily in divided doses. For general health: 200-500mg daily. Avoid megadoses (>2000mg) unless supervised, as excess is excreted and may cause GI upset.",
      },
      {
        icon: Shield,
        title: "Quality & testing",
        description:
          "Choose products with third-party testing (USP, ConsumerLab) to verify potency and purity. Vitamin C is relatively stable but check expiration dates.",
      },
      {
        icon: CheckCircle2,
        title: "Whole food sources",
        description:
          "Dietary sources (citrus fruits, bell peppers, broccoli) provide vitamin C with additional beneficial phytonutrients. One medium orange provides ~70mg. Supplements are useful for therapeutic doses or when dietary intake is inadequate.",
      },
    ],
    ...
    references: [
      ...
      {
        authors:
          "Shrestha, D.B., Budhathoki, P., Sedhai, Y.R., Mandal, S.K., et al.",
        year: "2021",
        title:
