...
// ✅ v0.7.0: Updated to accept database content as props
interface AshwagandhaPageProps {
...
}: AshwagandhaPageProps) {
  const pageProps: KnowledgebasePageProps = {
    supplementName: "Ashwagandha",
    currentPage: "ashwagandha",
    heroDescription:
      "Evidence-based overview of this Ayurvedic adaptogen herb best known for reducing stress and anxiety, with potential benefits for sleep, testosterone, and physical performance.",
    heroImageUrl: getSupplementImage("ashwagandha"),

    overviewTitle: "What is Ashwagandha?",
    // ✅ v0.7.0: Use database content if provided, fallback to hardcoded JSX
    overviewContent: dbOverviewContent || (
      <p>
        Ashwagandha (Withania somnifera) is an{" "}
        <span className="font-medium">adaptogen</span>—an herb that helps the
        body adapt to stress. The roots are most commonly used in supplements,
        and it's been a cornerstone of Ayurvedic medicine for centuries.
      </p>
    ),
    dietarySources: [
      {
      ...
      },
      {
        ...
        description:
          "1.5–35% withanolides; dosing often unclear in consumer products",
      },
    ],
    // ✅ v0.7.0: Use database content if provided, fallback to hardcoded JSX
    additionalOverviewContent: dbAdditionalContent || (
      <p>
        Withanolides, the active compounds in ashwagandha, affect GABAergic and
        other neurotransmitter pathways, supporting anxiolytic and adaptogenic
        effects. The herb also reduces cortisol (stress hormone) and modulates
        immune function, with mild effects on testosterone and other hormones.
      </p>
    ),
    ...
    benefits: [
      {
        ...
        description:
          "Consistently reduces stress and anxiety scores in multiple randomized controlled trials (RCTs)",
      },
      {
        icon: Moon,
        title: "Sleep Quality",
        description:
          "Improves sleep quality and onset latency, especially in individuals with insomnia",
      },
      {
        icon: TrendingUp,
        title: "Testosterone (Men)",
        description:
          "May modestly increase testosterone in some populations, particularly infertile men or those with low baseline levels",
      },
      {
        icon: Zap,
        title: "Physical Performance",
        description:
          "May enhance strength, cardiorespiratory fitness, and recovery in athletes",
      },
      {
        icon: Shield,
        title: "Cognitive Function",
        description:
          "Preliminary evidence suggests improvements in memory, attention, and information processing",
      },
    ],
    ...
    drawbacks: [
      {
        ...
        description:
          "Some users report mild GI issues (nausea, stomach discomfort) at higher doses",
      },
      {
        icon: Pill,
        title: "Thyroid Interaction",
        description:
          "May increase thyroid hormone levels; caution advised if you have thyroid conditions or take thyroid medication",
      },
      {
        icon: Heart,
      ...
      },
      {
        ...
        title: "Drowsiness",
        description:
          "Can cause drowsiness in some individuals; avoid combining with sedatives or operating heavy machinery until you know how it affects you",
      },
    ],
    ...
    researchGrades: [
      {
        ...
        description:
          "Strong, consistent evidence from multiple high-quality RCTs showing significant reductions in perceived stress and anxiety.[1][4][7][14] A 2021 meta-analysis[1] of 12 studies (n=1,002 participants) found ashwagandha significantly reduced stress scores (SMD: -0.63) and cortisol levels (SMD: -0.52) compared to placebo.",
      },
      {
        letter: "A",
        title: "Sleep Improvement",
        description:
          "Good evidence from several RCTs demonstrating improved sleep quality and reduced sleep latency.[6][8][12][13] A 2021 systematic review and meta-analysis[12] of 5 RCTs (n=400) showed ashwagandha improved overall sleep quality (SMD: 0.59), with greater effects in adults with insomnia (≥600mg/day for ≥8 weeks showed optimal results).",
      },
      {
        letter: "A",
        title: "Physical Performance",
        description:
          "Strong evidence showing improvements in strength, endurance, and recovery in athletic populations.[3][10] A 2020 meta-analysis[3] of 12 studies found significant increases in muscle strength (SMD: 1.36) and VO2max (MD: 1.79 mL/kg/min) with doses ranging from 120-1,250mg daily.",
      },
      {
        letter: "B",
        title: "Testosterone Enhancement",
        description:
          "Mixed evidence with moderate support in specific populations.[9][11] A 2022 meta-analysis[9] of 8 RCTs (n=445 male participants) showed ashwagandha significantly increased total testosterone (SMD: 0.63), with larger effects in infertile men and those with low baseline levels. Effects less consistent in healthy males.",
      },
      {
        letter: "C",
        title: "Cognitive Function",
        description:
          "Preliminary evidence suggests improvements in memory, attention, and information processing.[5] A 2017 systematic review[5] found positive effects on executive function, attention, and reaction time, but noted heterogeneity in study designs and small sample sizes.",
      },
    ],
      ...
      outcomes: [
        {
          ...
          signsOfEffectiveness:
            "Reduced perceived stress and anxiety, lower cortisol levels, improved mood stability, and better overall sense of calm. Noticeable within 2-4 weeks with optimal effects at 6-8 weeks.",
        },
        {
          icon: Moon,
          ...
          intensity: "High" as const,
          signsOfEffectiveness:
            "Better sleep quality, reduced sleep onset time, and more restful nights. Benefits often appear within 4-6 weeks with greater improvements at 8+ weeks.",
        },
        {
          icon: Zap,
          ...
          intensity: "High" as const,
          signsOfEffectiveness:
            "Enhanced recovery from exercise, measurable increases in strength and endurance for athletes. Performance changes may take 8-12 weeks to manifest fully.",
        },
        {
          icon: TrendingUp,
          ...
          signsOfEffectiveness:
            "Modest increases in testosterone levels in men, improved vitality and energy. Consistent use over 8-12 weeks shows best results.",
        },
      ],
    },

    buyingGuideIntro:
      "When shopping for ashwagandha supplements, consider these key factors:",
    buyingGuideItems: [
      {
        icon: Activity,
        title: "Standardization",
        description:
          "Look for products standardized to withanolide content (typically 1.5-5%). KSM-66 and Sensoril are well-researched branded extracts with clinical backing.",
      },
      {
        icon: Shield,
        title: "Third-party testing",
        description:
          "Choose supplements verified by USP, NSF, or ConsumerLab for quality and purity assurance.",
      },
      {
        icon: Pill,
        title: "Root extract vs. whole plant",
        description:
          "Most research uses root-only extracts. Check the label to ensure you're getting the studied form.",
      },
      {
        icon: CheckCircle2,
        title: "Dosage per serving",
        description:
          "Verify the elemental ashwagandha content matches research doses (typically 300-600mg of standardized extract).",
      },
    ],
    ...
    references: [
      ...
      {
        authors:
          "Wankhede, S., Langade, D., Joshi, K., Sinha, S.R., Bhattacharyya, S.",
        year: "2015",
        title:
      ...
      {
        authors:
          "Bonilla, D.A., Moreno, Y., Gho, C., Petro, J.L., Odriozola-Martínez, A., Kreider, R.B.",
        year: "2021",
        title:
      ...
      {
        authors:
          "Cheah, K.L., Norhayati, M.N., Husniati Yaacob, L., Abdul Rahman, R.",
        year: "2021",
        title:
