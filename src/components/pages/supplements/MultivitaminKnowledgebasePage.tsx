...
interface MultivitaminPageProps {
...
}: MultivitaminPageProps = {}) {
  const pageProps: KnowledgebasePageProps = {
    supplementName: "Multivitamin",
    currentPage: "multivitamin",
    heroDescription:
      "Evidence-based overview of comprehensive vitamin and mineral supplements with population-specific efficacy ranging from no mortality benefit in healthy adults to reduced cataracts in older adults, improved pregnancy outcomes, and consistent safety profiles across all groups.",
    ...
    overviewContent: dbOverviewContent || (
      <p>
        A multivitamin is a{" "}
        <span className="font-medium">combination supplement</span> containing a
        variety of vitamins and minerals, often with other beneficial nutrients.
        Formulations vary widely from basic "one-a-day" products covering
        recommended dietary allowances to comprehensive blends with dozens of
        ingredients at varying potency levels.
      </p>
    ),
    dietarySources: [
      {
      ...
      },
      {
        ...
        description:
          "Designed for specific groups (men, women, seniors, prenatal)",
      },
      {
        icon: Activity,
        title: "High-potency versions",
        description:
          "Contain higher doses of certain nutrients; may not always be beneficial",
      },
    ],
    additionalOverviewContent: dbAdditionalContent || (
      <p>
        Multivitamins are designed as "nutritional insurance" to prevent
        deficiencies, but they cannot replace a balanced diet rich in whole
        foods, which provide fiber, phytonutrients, and other beneficial
        compounds not found in supplements.
      </p>
    ),
    ...
    benefits: [
      {
        ...
        description:
          "Fills common nutritional gaps, especially important for restricted diets or certain life stages",
      },
      {
        icon: Eye,
        title: "Eye Health",
        description:
          "Strong evidence for reduced risk of age-related cataracts in adults over 40",
      },
      {
        icon: Apple,
        title: "Pregnancy Support",
        description:
          "Prenatal formulas prevent neural tube defects and support healthy birth outcomes",
      },
      {
        icon: Brain,
        title: "Cognitive Support",
        description:
          "Some evidence for cognitive benefits in older adults or those with marginal deficiencies",
      },
      {
        icon: Heart,
        title: "General Health",
        description:
          "May support overall health and wellbeing when dietary intake is inadequate",
      },
    ],
    ...
    drawbacks: [
      {
        ...
        description:
          "Cannot replace a healthy, varied diet; whole foods provide more than isolated nutrients",
      },
      {
        icon: Pill,
        title: "Nutrient Interactions",
        description:
          "Some nutrients compete for absorption (e.g., calcium and iron, zinc and copper)",
      },
      {
        icon: FlaskConical,
        title: "Risk of Excess",
        description:
          "High doses of fat-soluble vitamins (A, D, E, K) can accumulate and cause toxicity",
      },
      {
        icon: Activity,
        title: "Quality Varies",
        description:
          "Many products contain unnecessary fillers, low-quality forms, or ineffective doses",
      },
    ],
      ...
      outcomes: [
        {
          ...
          signsOfEffectiveness:
            "Normalized blood levels of vitamins and minerals in those with dietary insufficiencies. Reduced risk of frank deficiency states. Most noticeable in those with poor dietary intake or increased needs.",
        },
        {
          icon: Eye,
          ...
          signsOfEffectiveness:
            "Slowed progression of age-related macular degeneration (AMD) in those with intermediate AMD or advanced AMD in one eye (AREDS formula). Reduced risk of progression to advanced AMD by 25-28%. Long-term benefit requiring years of consistent use.",
        },
        {
          icon: Apple,
          ...
          intensity: "High" as const,
          signsOfEffectiveness:
            "Reduced risk of neural tube defects, anemia, and preterm birth. Adequate folate levels prevent birth defects. Supports maternal and fetal health throughout pregnancy. Most critical in first trimester but beneficial throughout.",
        },
        {
          icon: Brain,
          ...
          signsOfEffectiveness:
            "Subtle improvements in energy, immune function, and overall wellbeing, particularly if baseline diet is inadequate. Benefits most noticeable in those with restricted diets, older adults, or specific life stages (pregnancy, menopause). Cognitive benefits (memory, attention) may emerge in older adults or those with marginal deficiencies after 2-6 months.",
        },
      ],
    },
    ...
    buyingGuideItems: [
      {
        ...
        description:
          "Men's, women's, prenatal, or senior formulas address specific needs. Gender-specific or age-specific is often better than generic. Prenatal formulas should contain adequate folate (400-800 mcg as methylfolate), iron, and other key nutrients.",
      },
      {
        icon: Pill,
        title: "Check nutrient forms",
        description:
          "Look for bioavailable forms: methylfolate (not folic acid), methylcobalamin or adenosylcobalamin (B12), citrate or glycinate minerals (not oxide). Avoid synthetic vitamin E (dl-alpha-tocopherol); choose natural forms (d-alpha-tocopherol). Check for vitamin K2 (MK-7) rather than K1 for bone health.",
      },
      {
        icon: Shield,
        ...
        description: (
          <>
            ...
            to ensure quality and label accuracy. These certifications verify
            that products contain what they claim and are free from
            contaminants.
          </>
        ),
      },
      {
        ...
        description:
          "Stick close to 100% Daily Value for most nutrients unless addressing a specific deficiency under medical guidance. Avoid products with 500%+ of fat-soluble vitamins (A, D, E, K). Excessive doses don't provide additional benefits and may increase toxicity risk.",
      },
    ],
