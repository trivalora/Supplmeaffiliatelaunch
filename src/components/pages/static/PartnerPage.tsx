...
const imgForestAerial =
  "/optimized/4bdf2cba5e05e7d70b9f1402336825a64b04e236-1920.webp";
        ...
        <div data-layout-container className="relative z-10">
          <div className="text-center max-w-4xl mx-auto px-[5vw] md:px-0">
            <h1 className="mb-4 text-white text-4xl md:text-5xl">
              We compare supplement prices with real-time accuracy for US
              shoppers.{" "}
              <span style={{ color: "var(--secondary)" }}>Partner-ready.</span>
            </h1>

            <p className="mb-8 text-white/80 text-base md:text-lg max-w-2xl mx-auto">
              We list only compliant retailers. FTC/FDA safe claims. Clean
              traffic. Fast integration.
            </p>
      ...
      <div data-layout-container className="py-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-foreground">
                  <strong>1,867 SKUs live</strong> across 17 supplement
                  categories. Update cadence: <strong>2x/day</strong> (increased
                  during Black Friday and major retail events).
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-foreground">
                  SEO articles: <strong>17+ guides</strong>, Review comparisons:{" "}
                  <strong>1,867 product pages</strong>, Paid testing:{" "}
                  <strong>$500/day</strong> budget for targeted campaigns.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-foreground">
                  <strong>United States only</strong> (English). Optimized for
                  US shoppers with region-specific pricing and retailer
                  partnerships.
                </p>
              </div>
            </div>
        ...
        <section className="mb-16 bg-white py-12">
          <div data-layout-container>
            <div className="max-w-4xl mx-auto">
              <h2 className="mb-8 text-primary text-center">
                Compliance & Safety
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex gap-4">
                  ...
                  />
                  <div>
                    <h4 className="mb-1" style={{ color: "var(--primary)" }}>
                      FTC Compliance
                    </h4>
                    <p className="text-foreground">
                      Affiliate disclosures on every product listing and
                      comparison page.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">
                      No disease claims; structure/function only. Medical
                      disclaimer sitewide.{" "}
                      <a
                        href="https://www.fda.gov"
                        target="_blank"
                        rel="nofollow noreferrer"
                        className="text-fourth underline"
                      >
                        (fda.gov)
                      </a>
                    </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">
                      Privacy Policy, Terms of Service, Cookie Policy, and
                      Contact page with business address.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">
                      No coupons/incentives, no doorway pages, no paid search
                      brand-bidding.{" "}
                      <a
        ...
        <section className="mb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="mb-8 text-foreground text-center max-w-2xl mx-auto">
              Visual proof beats claims. See how your brand can appear across
              our platform.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="mb-3 text-foreground">
                  Featured placement in side-by-side product comparisons with
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h4 className="mb-3" style={{ color: "var(--primary)" }}>
                  Retailer Badge Features
                </h4>
                <p className="mb-3 text-foreground">
                  Trusted retailer badges on knowledge base pages with prominent
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="mb-3 text-foreground">
                  Featured "Best Price" and "Editor's Choice" slots in category
                  roundup pages.
                </p>
                <a
                  href="/ashwagandha"
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="mb-3 text-foreground">
                  Dedicated product spotlights in monthly email campaigns to
                  engaged supplement buyers.
                </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-foreground">
                    Price feed refresh cycle with automated mismatch alerts
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-foreground">
                    Manual QA checklist: pricing accuracy, link validation,
                    content review
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-foreground">
                    Broken-link sweeps across all product pages and affiliate
                    URLs
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <ul className="space-y-2 text-foreground">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle2
                      ...
                      style={{ color: "var(--primary)" }}
                    />
                    Google Tag Manager for event tracking and conversion
                    monitoring
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-6 p-4 bg-tertiary rounded-lg">
                <p className="text-foreground text-sm">
                  <strong>Note:</strong> ShareASale expects a live, content-rich
                  site and a clear traffic plan.{" "}
                  <a
                    href="https://help.shareasale.com"
                    target="_blank"
                    rel="nofollow noreferrer"
                    className="text-fourth underline"
                  >
                  ...
                  We meet all requirements for network approval.
                </p>
              </div>
            </div>
          </div>
          ...
          <div data-layout-container>
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-foreground">
                  Ready to activate? Fill out this quick form and we'll schedule
                  a 10-minute partner review.
                </p>
              </div>
              ...
              <p className="mt-6 text-center text-foreground/60 text-sm">
                We typically respond within 24-48 hours. For urgent requests,
                email us directly at{" "}
                <a
                  href="mailto:partners@suppl.me"
                  className="text-fourth underline"
                >
                  partners@suppl.me
                </a>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="space-y-6 text-foreground">
                ...
                <div>
                  ...
                  <p>
                    Numbers beat adjectives. We provide exact SKU counts, update
                    frequencies, traffic plans, and compliance documentation.
                    This removes guesswork and accelerates approval decisions.
                  </p>
                </div>

                <div>
                  <h4 className="mb-2" style={{ color: "var(--primary)" }}>
                    De-Risked Partnership
                  </h4>
                  <p>
                    Clear compliance standards, FTC/FDA-safe content, and
                    transparent traffic sources mean you're partnering with a
                    platform built for long-term, sustainable growth—not quick
                    wins that risk your brand.
                  </p>
                </div>

                <div>
                  <h4 className="mb-2" style={{ color: "var(--primary)" }}>
                    Quality Traffic Promise
                  </h4>
                  <p>
                    Our audience is actively researching supplements with
                    purchase intent. They're comparing prices and reading
                    evidence-based content—not browsing casually. This drives
                    higher conversion rates and better EPCs.
                  </p>
                </div>
              </div>
            </div>
