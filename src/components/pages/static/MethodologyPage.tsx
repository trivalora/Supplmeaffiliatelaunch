...
export function MethodologyPage() {
  return (
    ...
    >
      ...
      {/* Methodology Details */}
      <ContentSection title="How We Build Our Knowledge Base" background="secondary">
        <div className="flex flex-col gap-8">
          ...
          <InfoBlock
            ...
            description="We identify all randomized controlled trials (RCTs) for each specific supplement and use case. This systematic approach ensures we don't cherry-pick studies or miss important evidence that could change the conclusions."
          >
