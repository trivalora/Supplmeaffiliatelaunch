    ...
    >
      <div data-layout-container className="mx-auto">
        ...
        <div className="flex justify-center md:justify-start gap-6 mt-8">
          ...
          <a
            href="https://twitter.com/suppl_me"
            target="_blank"
            rel="noopener noreferrer"
            className="text-secondary hover:opacity-80 transition-opacity"
          ...
          <a
            href="https://linkedin.com/company/suppl-me"
            target="_blank"
            rel="noopener noreferrer"
            className="text-secondary hover:opacity-80 transition-opacity"
          ...
          <a
            href="https://instagram.com/suppl.me"
            target="_blank"
            rel="noopener noreferrer"
            className="text-secondary hover:opacity-80 transition-opacity"
        ...
        <div className="flex justify-center mt-8">
          <div
            className="border-t border-secondary/25"
            style={{ width: "20vw" }}
          ></div>
        </div>
        ...
        <div className="text-center pb-4 pt-4">
          <p className="text-secondary text-xs">© 2025 - Trivalora, Inc.</p>
        </div>
      </div>
    </div>
  );
