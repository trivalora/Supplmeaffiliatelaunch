...
const AVAILABLE_SUPPLEMENTS = [
  ...
  },
  {
    id: "bcaa-comparison",
    name: "BCAAs",
    keywords: ["bcaa", "bcaas", "branched chain", "amino acid"],
  },
  { id: "calcium-comparison", name: "Calcium", keywords: ["calcium"] },
  {
    id: "casein-protein-comparison",
    name: "Casein Protein",
    keywords: ["casein", "casein protein"],
  },
  {
    id: "collagen-comparison",
    name: "Collagen",
    keywords: ["collagen", "collagen peptides", "peptides"],
  },
  {
    id: "creatine-comparison",
    name: "Creatine",
    keywords: ["creatine", "creatine monohydrate"],
  },
  {
    id: "curcumin-comparison",
    name: "Curcumin",
  ...
  {
    id: "vitamin-c-comparison",
    name: "Vitamin C",
    keywords: ["vitamin c", "ascorbic", "vit c"],
  },
  {
    id: "vitamin-d-comparison",
    name: "Vitamin D",
    keywords: ["vitamin d", "vit d", "d3", "cholecalciferol"],
  },
  {
    id: "whey-protein-comparison",
    name: "Whey Protein",
    keywords: ["whey", "whey protein"],
  },
  // Note: zinc-comparison removed - zinc is knowledgebase-only, no comparison page exists
];
      ...
      <div className="flex items-center gap-3">
        ...
        {imageUrl && (
          <div className="dropdown-thumbnail">
            <Image src={imageUrl} alt={result.title} width={40} height={40} />
          </div>
        )}
...
export function SearchResults({
  ...
  const filteredResults = allSearchableRoutes
    .filter((route: any) => {
      ...
      return (
        ...
        (route.abbreviation &&
          route.abbreviation.toLowerCase().includes(searchLower))
      );
    })
  ...
  const knowledgebaseResults = filteredResults.filter(
    (r: any) => r.category === "knowledgebase" || !r.category
  );
  const glossaryResults = filteredResults.filter(
    (r: any) => r.category === "glossary"
  );
      ...
      <div className="search-results-content">
        <div className="py-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <div className="text-sm text-muted-foreground line-clamp-2">
                          View normalized price-per-unit comparisons across
                          retailers
                        </div>
                      </div>
                    </div>
          ...
          {knowledgebaseResults.length > 0 && (
            <>
              <div
                className="px-4 py-2 text-xs uppercase tracking-wide font-medium border-b border-secondary/20"
                style={{
                  color: "var(--primary)",
              ...
              {knowledgebaseResults.map((result: any, idx: number) => (
