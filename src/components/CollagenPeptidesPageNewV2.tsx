...
export function CollagenPeptidesPageNewV2({ 
  ...
  const pageProps: KnowledgebasePageProps = {
    ...
    overviewContent: (
      <p>
        Collagen is a <span className="font-medium">structural protein</span> comprising roughly a third of the body's total protein. <span className="font-medium">Collagen peptides</span> are hydrolyzed (pre-digested) fragments of collagen, making them more easily absorbed by the body.
      </p>
    ),
    dietarySources: [
      {
        ...
        description: "Short chains of amino acids derived from collagen by enzymatic hydrolysis"
      },
      {
        icon: Activity,
    ...
    additionalOverviewContent: (
      <p>
        Collagen peptides contain primarily glycine, proline, and hydroxyproline, which support connective tissue repair and function throughout the body.
      </p>
    ),
    ...
    benefits: [
      {
        icon: Bone,
        title: "Joint Health",
        description: "May reduce joint pain and improve mobility in osteoarthritis and athletes"
      },
      {
        icon: Sparkles,
        title: "Skin Health",
        description: "Improvements in skin hydration, elasticity, and reduction in visible aging signs"
      },
      {
        icon: Shield,
        title: "Bone Density",
      ...
      },
      {
        icon: Heart,
        title: "Wound Healing",
        description: "Collagen is critical for tissue repair and may accelerate healing"
      }
    ],
    ...
    drawbacks: [
      {
        ...
        description: "Some users report bloating or feelings of fullness; high doses may cause mild GI upset"
      },
      {
        icon: Activity,
        title: "Allergies",
        description: "Not suitable for those with allergies to the source animal (bovine, porcine, or fish)"
      },
      {
        icon: Droplet,
    ...
    buyingGuideItems: [
      {
        icon: Activity,
        title: "Source",
        description: "Choose based on preference and allergies: bovine (Type I & III), marine (Type I), or porcine. Grass-fed and wild-caught options available."
      },
      {
        icon: Shield,
        title: "Third-party testing",
        description: "Look for USP, NSF, or Informed-Sport certification for quality and purity."
      },
      {
        icon: Pill,
        title: "Hydrolyzed vs. Gelatin",
        description: "Ensure you're getting hydrolyzed collagen (peptides), which dissolve easily. Gelatin requires heat."
      },
      {
        icon: CheckCircle2,
        title: "Additives",
        description: "Check for unnecessary fillers, sweeteners, or flavoring. Pure unflavored options are most versatile."
      }
    ],
    ...
    references: [
      ...
      {
        authors: "Zdzieblik, D., Oesser, S., Baumstark, M.W., Gollhofer, A., König, D.",
        year: "2015",
      ...
      {
        authors: "García-Coronado, J.M., Martínez-Olvera, L., Elizondo-Omaña, R.E., et al.",
        year: "2019",
      ...
      {
        authors: "Hexsel, D., Zague, V., Schunck, M., Siega, C., Camozzato, F.O., Oesser, S.",
        year: "2017",
