...
export function SublingualPage() {
  return (
    <GlossaryTemplate
      ...
      definition="A method of taking supplements by placing them (typically tablets, lozenges, liquids, or sprays) under the tongue where they dissolve and are absorbed directly into the bloodstream through the mucous membranes, bypassing the digestive system and first-pass liver metabolism."
      
      detailedExplanation="The term comes from the Latin 'sub' (under) and 'lingua' (tongue). This route bypasses the digestive system and first-pass liver metabolism, potentially offering faster absorption and higher bioavailability for certain compounds.
