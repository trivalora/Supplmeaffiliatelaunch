...
export function MicronizedPage({
  ...
  return (
    <GlossaryTemplate
      term="Micronized"
      definition="A process that reduces supplement particles to extremely small sizes, typically less than 20 micrometers (0.02 millimeters) in diameter. This mechanical process increases the surface area of particles, which can improve dissolution, absorption, and bioavailability of certain supplements."
      
      detailedExplanation="How Micronization Works:
