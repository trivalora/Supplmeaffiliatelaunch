...
- Screening and treatment of at-risk populations (exclusively breastfed infants, dark-skinned children in northern latitudes, children with malabsorption)`}
      examples={[
        "An exclusively breastfed infant without vitamin D supplementation may develop rickets by 6-12 months of age, presenting with delayed fontanelle closure and rachitic rosary.",
      ...
      relatedTerms={[
        ...
        { term: "Osteomalacia", key: "osteomalacia" },
