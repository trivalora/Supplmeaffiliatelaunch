...
**Population considerations:** The lower bioavailability of non-heme iron is particularly relevant for populations with increased iron needs (pregnant women, adolescents, menstruating women) who rely heavily on plant sources. The Institute of Medicine recommends vegetarians consume 1.8 times the normal RDA to compensate for lower absorption."
      examples={[
        "A cup of cooked lentils provides 6.6 mg non-heme iron with ~5% baseline absorption (330 mcg absorbed). Adding 75 mg vitamin C (from a medium bell pepper) can increase absorption to 10-15% (660-990 mcg absorbed), tripling iron intake.",
        "Drinking a cup of black tea with a plant-based meal containing 10 mg non-heme iron can reduce absorption from 500 mcg (5%) to 100 mcg (1%) due to tea polyphenols—an 80% reduction.",
        "Studies show that vegetarians who strategically pair iron-rich foods with vitamin C sources maintain normal iron status despite consuming only non-heme iron, while those who regularly consume tea with meals show higher rates of iron deficiency."
      ]}
      relatedTerms={[
        { term: "Ferrous Iron", key: "ferrousiron" },
        { term: "Heme Iron", key: "hemeiron" },
